...
const Carousal = () => {
  ...
  return (
    <div style={{width:'1320px', height:'450px', margin:'15px'}} className=' 
     relative group'>
        
        <div className='w-full h-full rounded-2xl bg-center bg-cover transition-all ease-in-out duration-1000'>
            <img  style={{width:'1320px', height:'450px', borderRadius:'15px', transition:'3s'}} src={slides[index]} alt="" />
        </div>
